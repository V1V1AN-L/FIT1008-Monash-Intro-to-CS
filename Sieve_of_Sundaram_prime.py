""" some prime thing I copied from stack overflow. used in primes.py to generate
    max prime less than upper_limit"""
...
def get_highest_prime(limit):
    return binarySearch(1, len(primes) - 1, limit)
# Driver Code
#Sieve();
#n = 25;
#print(binarySearch(0, len(primes) - 1, 6));